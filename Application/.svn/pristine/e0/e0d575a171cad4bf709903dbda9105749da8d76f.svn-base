...
<body class="gray-bg">
<form target="hidframe"  method="post" id="myform" action="<?php if(!empty($userinfo)){echo M_URL('Setting','doeditUsers',$userid,GP("usertype-$usertype,p-$now_page"));}else{echo M_URL('Setting','doaddUsers','',GP(''));} ?>" class="form-horizontal" enctype="multipart/form-data">
