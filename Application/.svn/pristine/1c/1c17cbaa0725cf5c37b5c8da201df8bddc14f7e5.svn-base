...
<div class="panel-heading">模版zip管理-----/<?php echo $tempdir;?>-------你点的file按钮的name是(测试用)----<?php echo $name;?></div>
<table class="table " >
    <thead>
    <tr>
        <th>zip目录</th><th>类型</th><th>大小</th><th>修改时间</th><th>操作</th>
    </tr>
    </thead>
    <tbody>
    <?php if(!empty($first)){?>
...
<script>
uploadView2(180,120,{picker:'#picker',filelist:'#filelist',url:'/Plus/Uploader.php?act=templist&temptype=<?php echo $temptype; ?>'});
