...
<body class="ks-wrap">
<form target="hidframe" action="<?php echo M_URL('Capital','saveSalesWithdrawmoney');  ?>" method="post" id="myform">
<div class="bRadius10 ks-wbox ">
	<div class="ks-head-nav">
		<!--标题-->
		<a href="javascript:history.go(-1);">推广中心</a><span> <em>/</em> 提现申请
		<!--标题-->
	</div>
							...
							<li>
								...
								<div class="Created-Content">
									<div class="form-row clearfix" >
										...
										可提现金额<i style="color:#e83423"><?php echo $result['no_withdrawal'];?></i>元&nbsp;&nbsp;实际到账<i style="color:#e83423" id="actualmoney">0.00</i>元</p>
...
$("#withdraw_money").keyup(function () {
	...
	var poundage    = '<?php echo checkIsVipVersion($this->wxid)? number_format($base['poundage1'],2):number_format($base['poundage'],2);?>';
