...
<div id="manage_top" class="menu_top_fixed">
					  <div class="ibox-title fl mr15 ml15">
                       <h3><?php echo $table['itemname'].$tableModel->prefix.$table['tablename'];?>自定义字</h3>
...
<form target="hidframe"  action="<?php if(!isset($field)){echo M_URL('Setting','doaddfield',$tableid);}else{echo M_URL('Setting','doeditField',$field['fieldid'],GP("p-$now_page,tableid-$tableid"));} ?>" method="post" class="form-horizontal" id="myForm">
