            ...
            <form action="<?php echo M_URL('Setting','batch','',GP('')); ?>" method="post" target="hidframe" id="myform">
                <table class="table table-striped table-bordered table-hover" id="editable">
                    ...
                    <tr>
                        ...
                        <td><input class="form-control w300" type="text" name="price[]"  value="<?php echo $v['price'] ?>"></td>
                        <td style="width: 90px">
                        ...
                        <td><a href="/admin.html/default/Setting/liveChannelList?service=<?php echo $v['title'];?>" >查看</a></td>
                        <td style="width: 90px"> <a href="<?php echo M_URL('Setting','editlive',$v['id'],GP('type-4')); ?>"><i class="edit2017"></i></a></td>
                        <td style="width: 90px"><a onclick="Confirm('是否删除此应用','<?php echo M_URL('Setting','delInterface',$v['id'],GP('')); ?>');"><i class="delete2017"></i></a></td>
                    </tr>
                    <?php } ?>
                    </tbody>
                </table>
