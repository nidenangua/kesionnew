...
<body>
<form target="hidframe" action="<?php {echo M_URL('Setting','userMassageSend',$id,GP(""));} ?>" method="post" class="form-horizontal">
<div class="livePaly-PchatBox">
	<div class="PchatBox-content">
		<div class="PchatBox-title"><h2>给用户<?php echo $userid;?>发送站内信</h2></div>
