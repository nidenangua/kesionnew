...
<div id="manage_top" class="menu_top_fixed  p15 height73" >
    <div class="ibox-title clearfix"> 
        <h3 class="fl ">&nbsp;&nbsp;<span class="mr20">其他用户</span>
        	...
        	<a href="<?php echo M_URL('Setting','userIndex','',GP('usertype-1')); ?>" class="mr20 <?php if($usertype==1){echo 'act';}?>">教师管理</a> 
        	<a href="<?php echo M_URL('Setting','userIndex','',GP('usertype-2')); ?>" class="mr20 <?php if($usertype!=1){echo 'act';}?>">机构会员</a>  
        	<a href="<?php echo M_URL('Setting','userIndex','',GP('usertype-3')); ?>" class="mr20">学员管理</a> 
        ...
        <!-- <a class="btn btn-tool btn-rounded btn-s-md fl" href="<?php echo M_URL('Setting','addUsers','',GP('')); ?>" style="margin-left:15px">添加会员</a> -->
        <div class="fr">
            ...
            <input type="submit" class="sc-button" onclick="searchByClass('<?php echo GP(''); ?>','<?php echo M_URL('Setting','userIndex'); ?>','<?php echo URL_MODEL;?>')" name="searchBtn" value="搜索">
			</form>
	   ...
	   <table class="ks-table" style="background: #fff;">
                    ...
                    <tbody>
                    	...
                    	<tr>
                    		...
                    		<td><img style="    width: 74px;" class="showImg" onerror="this.src='<?php echo nopic();?>'" src="<?php echo $this->upload->getHead($v['userid']);?>"></td>
                    		...
                    		<td>
                    			 <span onclick="Confirm('是否删除？该操作不可逆!','<?php echo M_URL('Setting','deleteUsers',$v['userid'],GP('p-'.$page->now_page)); ?>')"><i class="iconfont icon-lajitong"></i></span>
                    		</td>
                    		<td class="ks-head-el">
                                ...
                                <div class="ks-head-content ks-head-content-pc">
                                    <ul class="opeart">
                                        <li>
                                            <a href="<?php echo M_URL('Setting','editUsers',$v['userid'],GP('p-'.$page->now_page)); ?>">编辑</a>
                                        </li>
                                        <li>
