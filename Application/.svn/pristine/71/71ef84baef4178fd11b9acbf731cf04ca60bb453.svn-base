...
<body class="ks-wrap" style="opacity: 1;">
			        					...
			        					<p>
								        	<div class="fr">
												...
												<div class="form-switch" open-value="1">
													<span class="link-switch<?php if($userinfo['status'] ==1){ echo ' open'; } ?>" data-off="<?php echo M_URL('Setting','userUpdatestatus',$userinfo['userid'],GP('')); ?>" data-open="<?php echo M_URL('Setting','userUpdatestatus',$userinfo['userid'],GP('')); ?>"><i></i></span>
												</div>
												</span>
											</div>
			        					</p>
	...
	<div class="bRadius10 bg-white ks-wbox mt20" >
		...
		<div class="detail"> 	
				...
				<ul>  
					<li <?php if($type==3){echo 'class="curr"';}?>><a href="<?php echo M_URL('Setting','details',$id,GP('type-3'));?>">全部</a></li>
					<li <?php if($type==1){echo 'class="curr"';}?>><a href="<?php echo M_URL('Setting','details',$id,GP('type-1'));?>">班级</a> </li>
					<li <?php if($type==0){echo 'class="curr"';}?>><a href="<?php echo M_URL('Setting','details',$id,GP('type-0'));?>">课程</a></li>
