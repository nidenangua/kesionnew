...
<div id="manage_top" class="menu_top_fixed  p15 height73" >
    <div class="ibox-title">
        ...
        <div class="fr">
            ...
            <input type="button" class="sc-button" onclick="searchByClass('<?php echo GP(''); ?>','<?php echo M_URL('Domain','loginlog'); ?>','<?php echo URL_MODEL;?>');" name="searchBtn" value="搜索">
			</form>	
			<!--搜索-->
			</div> 
        </div>
        ...
        <table class="ks-table" style="background: #fff;">
            ...
            <tbody>
            	<?php foreach($values as $k =>$v){ ?>
            		...
            		<td><?php if($v['type']==0){ echo '登陆';}else{echo '注销';} ?></td>
            		<td><?php if($v['logintype']==0){ echo 'PC端';}else{echo '手机或者PAD';} ?></td>
