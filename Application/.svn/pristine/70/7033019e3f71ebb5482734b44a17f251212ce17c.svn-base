...
<div id="manage_top" class="menu_top_fixed  p15 height73" >
    <div class="ibox-title clearfix">
       <h3 class="fl ">&nbsp;&nbsp;<span class="mr20">其他用户</span>
        	<a href="<?php echo M_URL('Users','','',GP('usertype-1')); ?>" class="mr20">教师管理</a> 
        	<a href="<?php echo M_URL('Users','','',GP('usertype-2')); ?>" class="mr20">机构会员</a>  
        	<a href="<?php echo M_URL('Users','','',GP('usertype-3')); ?>" class="mr20 act" style="color: blue">学员管理</a> 
        ...
        <div class="fr">
            ...
            <input style="position: relative;" type="submit" class="sc-button" onclick="searchByClass('<?php echo GP(''); ?>','<?php echo M_URL('Users','index'); ?>','<?php echo URL_MODEL;?>')" name="searchBtn" value="搜索">
			</form>
         ...
         <table class="ks-table" style="background: #fff;">
                    ...
                    <tbody>
                    	...
                    	<tr>
                    		...
                    		<td>
                    			 <span onclick="Confirm('是否删除？该操作不可逆!','<?php echo M_URL('Users','delete',$v['userid'],GP('')); ?>')"><i class="iconfont icon-lajitong"></i></span>
                    		</td>
                    		<td class="ks-head-el">
                                ...
                                <div class="ks-head-content ks-head-content-pc">
                                    <ul class="opeart">
                                        <li>
                                            <a href="<?php echo M_URL('Users','details',$v['userid'],GP('p-'.$page->now_page)); ?>">编辑</a>
                                        </li>
                                        <li>
                                            <a href="<?php echo M_URL('Users','details',$v['userid'],GP('p-'.$page->now_page)); ?>">查看详情</a>
                                        </li>
                                    </ul>
                                </div>
...
<div class="wrapper mt55 ">
    <div class="row">
        ...
        <div class="ibox-title">
            <h3 class="fl" >学员管理</h3>
             <a  href="<?php echo M_URL('Users','addUsers','','',GP("usertype-$usertype")); ?>" class="btn btn btn-info btn-rounded btn-s-md  ml15" style="color:#676a6c;margin-left:20px">添加</a>
    ...
    <div class="row"><br /><br />
        <div class="col-sm-12">
            ...
            <ul class="nav-tabs nav">
                ...
                <a href="<?php echo M_URL('Users','index','',GP('usertype-'.$usertype.',status-3',true)); ?>"> 所有</a>
                </li>
                <li <?php if($status==1)echo "class='active'";?>>
                <a href="<?php echo M_URL('Users','index','',GP('usertype-'.$usertype.',status-1',true)); ?>">正常</a>
                </li>
                <li <?php if($status==0)echo "class='active'";?>>
                <a href="<?php echo M_URL('Users','index','',GP('usertype-'.$usertype.',status-0',true)); ?>">待审</a>
                </li>
                <li <?php if($status==2)echo "class='active'";?>>
                <a href="<?php echo M_URL('Users','index','',GP('usertype-'.$usertype.',status-2',true)); ?>">锁定</a>
                </li>
           </ul>
<form target="hidframe"  action="<?php echo M_URL('Users','batch','',GP('p-'.$page->now_page)) ?>" method="post">
                        ...
                        <div class="ibox-content">
                            <table class="table table-bordered">
                                ...
                                <tr class="gradeX">
                                    ...
                                    <td class="center"><a href="<?php echo M_URL('Users','editUsers',$v['userid'],GP('p-'.$page->now_page)); ?>"><i class="edit2017"></i></a></td>
                                    <td class='center'><a href="javascript:void(0);" onclick="Confirm('确定删除？,该操作不可逆','<?php echo M_URL('Users','deleteUsers',$v['userid'],GP('p-'.$page->now_page)); ?>');"><i class="delete2017"></i></a></td>
                                </tr>
                                <?php } ?>
                                </tbody></table>
                           <?php echo NoC($UsersAll);?>
