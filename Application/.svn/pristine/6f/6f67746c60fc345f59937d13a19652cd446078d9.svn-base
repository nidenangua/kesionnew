        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form target="hidframe"  action="<?php if(isset($massage)){echo M_URL('Setting','emaildoeditormassage');}else{echo M_URL('Setting','emaildoaddmassage'); }?>" method="post" class="form-horizontal">
                        <div class="form-group">
                            <label class="col-sm-2 control-label">模块名称（英文）：</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control"   name="model" id="model" required 
                                value="<?php if(isset($massage["model"])) echo $massage["model"]; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control"   name="modelname" id="ModelName"                                    value="<?php if(isset($massage["modelname"])) echo $massage["modelname"]; ?>" required >
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-1">
                                <input type="number" class="form-control"   name="massagenum" id="model0"                                   required  value="<?php if(isset($massage["massagenum"])){echo $massage["massagenum"];}?>" >
                            </div>
                        </div>
                        <div class="hr-line-dashed"></div>
                      <div class="footer-page">
                        ...
                        <div class="col-sm-3 mt3">
                            <button class="btn btn-primary btn-s-md mt10" type="submit">保存</button>
