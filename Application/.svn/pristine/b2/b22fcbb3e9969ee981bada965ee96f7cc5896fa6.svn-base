            ...
            <div class="tab-content" id="ksBoxContent">
                <div class="tap-pane" style="display: block;margin-bottom: 200px;">
                    <div class="panel-body">
                        <form id="myform" target="hidframe"  class="form-horizontal" method="post" action="<?php if(isset($value)){echo M_URL('Setting','doeditInterface',$id,GP(''));}else{echo M_URL('Setting','doaddInterface','',GP(''));} ?>">
