...
<script src="<?php echo UOOT;?>Public/common/js/jquery.js"></script>
    <script src="<?php echo UOOT;?>Public/common/js/jquery.validate.min.js?<?php echoHash(); ?>"></script>
    <script src="<?php echo UOOT;?>Public/common/js/messages_zh.min.js?<?php echoHash(); ?>"></script>
<title>登录微门户 - 科汛专注新教育系统服务提供商</title>
</head>
<body style="background-color: #eef0f9;">
    ...
    <div class="login-content" style="margin-top: 3%;">
        <div class="mainbox clr">
	             ...
	             <div class="col-6">   
	             	<div class="login-center">
	             		<!-- <div class="login-logo">
	             			<a href="<?php echo UOOT;?>"><img src="<?php echo UOOT;?>Public/app/images/login/logo.png"></a>
	             		</div>
	             	 -->
		                ...
		                <div class="login-content-r">
		                    ...
		                    <div class="login-info clr" align="center">
		                        <form target="hidframe" id="myform" action="" method="post" class="form-horizontal">
									...
									<div class="newsign">还没有账号？<a href="/register">立即注册</a></div>
		                            <!-- <p class="und"></p> -->
		 ...
		 <div class="kexunbest"><p class="kexun-des"><span class="kexun-line-left"></span>
		 	科汛<span class="dot"></span>专注新教育的技术服务商
      	<span class="kexun-line-right"></span></p> <p class="kexun-records">Copyright © 2015-2019 厦门科汛软件有限公司 All Rights Reserved. 闽ICP备06009871号
<a target="_blank"
