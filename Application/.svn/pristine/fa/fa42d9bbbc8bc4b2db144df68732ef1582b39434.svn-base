        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
              <div class="ibox-content">
                  <form target="hidframe" action="<?php if(!isset($category)){echo M_URL('Offweb','questionClassifyManageDoSave');}else{echo M_URL('Offweb','questionClassifyManageDoSave',$category['categoryid']);} ?>" method="post" class="form-horizontal">
