...
<div class="ks-wbox bRadius10">
		<div class="ks-head-nav">
			...
			<div class="ks-head-tab" style="display: block;">
 			<ul class="clearfix">
 				<li   <?php if(ACTION =='serviceRecord' ){echo 'class="curr"';} ?> ><a href="<?php echo M_URL('Shop','serviceRecord',$serviceType); ?>">购买记录</a></li>
				<?php if($serviceType==1 || $serviceType==2 || $serviceType==4 || $serviceType==5 || $serviceType==7){ ?>
					<li   <?php if(ACTION =='consumptionRecord' ){echo 'class="curr"';} ?>>
                        <?php if ($serviceType==4){?>
                        <a href="<?php echo M_URL('Shop','consumptionRecord',$serviceType); ?>">播放记录</a>
                         <?php }else { ?>
						<a href="<?php echo M_URL('Shop','consumptionRecord',$serviceType); ?>">消费记录</a>
                        <?php }?>
					</li>
				<?php } ?>
 			</ul>
...
<!--							--><?php //echo $serviceType;?>
							<?php if($serviceType!=5&&$serviceType!=7){echo '<th>购买时长</th>';}?>
   							<th>购买时间</th>
   							<th>实际支付</th>
   						</tr>
   						...
   						<tr>
						    <td><?php echo $v['ordersn']; ?></td>
   							...
   							<td>
   								<?php 
   									switch($v['appid']){case 1:echo ($v['numb']*1000).'条';break;
   										...
   										case 3:echo format_gt($v['numb']);break;
   										case 4:echo format_gt($v['numb']);break;
   										case 6:echo floor($v['numb']).'人';break;
   										case 5:echo floor($v['numb']).'个';break;
   										case 7:echo floor($v['numb']).'小时';break;
   								}?>
   							</td>
   							<td>
   							<?php switch($v['appid']){case 1:echo $v['market_price'].'/千条';break;
									...
									case 7:echo $v['market_price'].'小时/元';break;
							}?>
   							</td>	
							<?php switch($v['appid']){case 1:echo '<td>--</td>';break;
									case 2:echo '<td>--</td>';break;
									case 3:echo '<td>版本服务期内有效</td>'; break;
						   	     ...
						   	     <?php break;
						   				case 4: ?>	
						   				   <table class="ks-table pay-border">
						   						...
						   						<tr>
						   							<td><?php echo $k+1; ?></td>
						   							<td><?php echo ($v['memberid']==0?'游客':User_GetUserName($v['memberid'])); ?></td>
