...
<body>
<form target="hidframe" action="<?php {echo M_URL('Website','doAddproblem','',GP(''));} ?>" method="post" class="form-horizontal">
	<div class="wrap">
		<div class="tab">
			<ul id="tab">
		...
		<div style="position: relative;margin-top: 40px;">
			<div class="card-box">
				...
				<div class="card-cont"><input type="text" name="title" style="border: solid 1px #E5E5E5;height: 30px;width: 100%;" /></div>
			</div>
			<?php echo ks_editor('massage',$input_value='',$type='1',$att='',$width='',$height='350px');?>
		</div>
		<div class="Psend-btn">
			...
			<input type="hidden"  name="wxid" value="<?php echo $this->wxid ?>"/>
		</div>
	</div>
