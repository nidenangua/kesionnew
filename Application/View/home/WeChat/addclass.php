...
<body style="background-color:#fff">
    ...
    <script src="<?php echo UOOT ?>Public/wechat/js/addclass.js?2018996"></script>
    <script src="https://store.kesion.com/Public/common/js/aliyun/alioss/lib/plupload-2.1.2/js/plupload.full.min.js"></script>
    <script src="https://store.kesion.com/Public/common/js/aliyun/alioss/upload.js?2018996"></script>
