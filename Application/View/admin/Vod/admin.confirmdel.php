...
<body class="gray-bg">
<div id="ksBoxContent">
<form target="hidframe"  method="post" target="hidframe"  action="<?php echo M_URL('Vdo','doconfirmdel',$id,GP('p-'.$now_page,true)) ?>" class="form-horizontal" enctype="multipart/form-data">
输入操作密码
<input name="password" type="text" value=""/>
<input name="vdoId"    type="hidden" value="<?php echo $vdoId;?>"/>
