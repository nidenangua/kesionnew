...
<div id="manage_top" class="menu_top_fixed  p15 height73">
    <div class="ibox-title">
        ...
        <div class="fr">
			...
			<!--搜索-->
				<a href="<?php echo M_URL('Coupon','index','',GP('p-'.$now_page));?>" class="ks-bt bt-def"><i class="iconfont icon-fanhui"></i>返回</a>
			<!--搜索-->
			</div>  
 	...
 	<form target="hidframe" id="myform"  action="<?php if(isset($ary)){echo M_URL('Coupon','editcoupon','',GP(''));}else{ echo M_URL('Coupon','addcoupon','',GP(''));}  ?>"  method="post">
