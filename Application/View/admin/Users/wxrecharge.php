...
<body>
	...
	<div class="tab" style="display: block;">
		<div class="info-ul">
			<form target="hidframe" id="myform"  method="post" class="form-horizontal" action="<?php echo M_URL('home/Users','dorecharge',$userid,GP(''));?>" enctype="multipart/form-data">
			<ul>
				<li>
					<span>支付方式：</span>
					 后台直充
				...
				<li>
					<span>操作类型：</span>
					<label for="up" class="fn"><input type="radio" class="fn" name="type" id="up" value="1" />增加</label>
					<label for="down" class="fn"><input type="radio" class="fn" name="type" id="down" value="2" />减少</label>
					
				</li>
				
				<li>
					操作金额：&nbsp;&nbsp;<input type="text" name="money" id="" value="" /> 元
