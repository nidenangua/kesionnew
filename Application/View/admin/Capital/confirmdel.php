...
<body class="gray-bg">
<div id="ksBoxContent">
<form target="hidframe"  method="post" target="hidframe"  action="<?php echo M_URL('home/Capital','unaudited',$id,GP('p-'.$now_page,true)) ?>" class="form-horizontal" enctype="multipart/form-data">
输入操作密码
<input name="password" type="text" value=""/>
<button type="submit"/>取消结算通过</button>
</form>
</div>
</body>
</html>
