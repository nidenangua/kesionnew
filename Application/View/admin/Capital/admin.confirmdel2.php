...
<body class="gray-bg">
<div id="ksBoxContent">
<form target="hidframe"  method="post"  action="<?php echo M_URL('Capital','dowxwithdraw2',$id,GP('p-'.$now_page,true)) ?>" class="form-horizontal" enctype="multipart/form-data">
输入操作密码
<input name="password" type="password" value=""/>
<button type="submit"/>确认结算通过</button>
</form>
</div>
</body>
</html>
