...
<body class="ks-wrap">
<form target="hidframe" action="<?php echo M_URL('Capital','withdrawmoney');  ?>" method="post" id="myform">
					...
					<ul>
						...
						<div class="xztype" style="display: block;">
							<li>
							    <h4>真实姓名:</h4>
								<div class="Created-Content">
									<div class="form-row clearfix"><input type="text" class="form-textbox w300" name="banknum[]" value="" ></div>						
								</div>
								注：请务必填写真实姓名，否则微信打款失败。
							</li>
							<li>
							    <h4></h4>
								<div class="Created-Content">
									<div class="form-row clearfix"><textarea type="text" id="nickname" readonly="true" style="height:34px;" disabled="false"></textarea>
									<button type="button" class="ks-heade-button mr10"  style="border-color:#e5412c;background:transparent;color:#e5412c;display: block;" onClick="addTypeChange('<?php echo M_URL('Capital','bingweixin');  ?>','850px','600px',{title:'绑定微信号',type:'top'})" >绑定微信号</button>
					...
					<div class="Created-ing clearfix">
						<ul>
							<li>
								<h4>结算金额:</h4>
								<div class="Created-Content">
									<input type="number" class="form-textbox w300" name="withdrawmoney" value="0.3" id="withdraw_money"/>元 (至少0.3)				
								</div>
							</li>
							<li>
								<h4>结算密码:</h4>
								<div class="Created-Content">
									<input type="password" class="form-textbox w300" name="password" id="withdraw_money"/>					
								</div>
							</li>
							<li>
								<h4>备注说明:</h4>
