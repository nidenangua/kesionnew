...
<div id="manage_top" class="menu_top_fixed  p15 height73" >
    <div class="ibox-title">
		...
		<a href="<?php echo M_URL('Capital\toperson');?>" class="mr20 act">微信打款到个人</a> 
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;提现总金额&nbsp;&nbsp;<font class="defColor" size="5px">￥<?php if($allcomoney){ echo $allcomoney;}else{echo 0;} ?></font>
        	<a href="<?php echo M_URL('Capital\withdraw'); ?>" class="btn btn-info btn-rounded btn-s-md  ml15" style="background: #FF5507;border: none;">打款</a>
        <div class="fr">
        <div class="fl ks-top-search mt7">
            ...
            <input type="button" class="sc-button" onclick="searchByClass('<?php echo GP(''); ?>','<?php echo M_URL('Capital','toperson'); ?>','<?php echo URL_MODEL;?>');" name="searchBtn" value="搜索">
			</form>		
			<!--搜索-->
		</div>   
        </div>
...
<div id="ksBoxContent">
	...
	<div class="H5-gameListScreen">
		<ul class=" nav nav-tabs">
	        <li class="fl hLh40 pl10 pr10 mr20 fsize18 <?php if($status==3) echo " curr" ;?>"><a>不限</a></li>
	    </ul>
	    <div>
	    	<li class="timelevel">
				<a  href="<?php echo M_URL('home/Capital','toperson','',GP("option-5")); ?>" id="<?php if($option ==5){ echo 'act';}?>">全部</a>
				<a  href="<?php echo M_URL('home/Capital','toperson','',GP("option-1,numb-0")); ?>" id="<?php if($option ==1&&$num==0){ echo 'act';}?>">本周</a>
				<a href="<?php echo M_URL('home/Capital','toperson','',GP("option-1,numb-1")); ?>" id="<?php if($option ==1&&$num==1){ echo 'act';}?>">上周</a>
				<a href="<?php echo M_URL('home/Capital','toperson','',GP("option-2,numb-0")); ?>" id="<?php if($option ==2&&$num==0){ echo 'act';}?>">本月</a>
				<a href="<?php echo M_URL('home/Capital','toperson','',GP("option-2,numb-1")); ?>" id="<?php if($option ==2&&$num==1){ echo 'act';}?>">上月</a>
				<a href="<?php echo M_URL('home/Capital','toperson','',GP("option-3,numb-0")); ?>" id="<?php if($option ==3&&$num==0){ echo 'act';}?>">本季度</a>
				<a href="<?php echo M_URL('home/Capital','toperson','',GP("option-3,numb-1")); ?>" id="<?php if($option ==3&&$num==1){ echo 'act';}?>">上季度</a>
			</li>
	    </div>
	</div>
	<div class="H5-gameListConts school-online">
		...
		<table class="ks-table" id="tables">
			<tr style="background: #EEEEEE;">
				...
				<th class="shaixuan">
			<?php if($adddate == 2){?>
				<a class="desc" href="<?php echo M_URL('home/Capital','toperson','',GP("adddate-1")); ?>"   style="float: none;"><i class="desc-i" style="top: -1px;"></i>提交时间</a>		
			<?php }else{ ?>
				<a class="desc" href="<?php echo M_URL('home/Capital','toperson','',GP("adddate-2")); ?>"   style="float: none;"><i class="asc-i" style="top: -1px;"></i>提交时间</a>
			<?php }?>
				</th>
				<th>结算金额</th>
            	<th>提现账号</th>
			...
			<tr>
				...
				<td>已结算</td>
				<td><a class="ok-icon ok-pe1" title="已结算"></a></td>
				<!--<th>
				<?php if($v['status']==1){ ?>
