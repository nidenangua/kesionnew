							  ...
							  $html .= "$v[categoryname]</td>
										...
										<td>
											<div class='form-group'>";
												...
												{				
												$html .= "<form target='hidframe'  method='post' action='".M_URL('Offweb','byAllUp',$v['categoryid'],GP('p-'.$page->now_page))."' class='form-horizontal'>
																	<div class='col-sm-2'>
												...
												{
												$html .= "<form target='hidframe'  method='post' action='".M_URL('Offweb','byAllDown',$v['categoryid'],GP('p-'.$page->now_page))."' class='form-horizontal'>
																	<div class='col-sm-2'>
																		     <select class='form-control' name='MoveNum'>
																			            <option>向下移动</option>";
