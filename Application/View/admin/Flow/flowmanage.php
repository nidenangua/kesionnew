		...
		<div class="row clearfix">
			<div id="manage_top" class="menu_top_fixed  p15 height73">
				<div class="ibox-title clearfix">
					<h3 class="fl">&nbsp;&nbsp;流量明细
					<a class="ml20" href="<?php echo  M_URL('Flow','showSpace','',GP('')); ?>">点播空间管理</a>
					</h3>
					...
					<div class="fr">
						<div class="fl ks-top-search">
							<form target="hidframe" >				
								<div class="ks-top-search" target="hidframe" action="<?php echo  M_URL('Flow','index','',GP('')); ?>" method="post">
									...
									<input type="submit" class="sc-button" name="" value="搜索" onClick="searchByClass('<?php echo GP(''); ?>','<?php echo M_URL('Flow','index'); ?>','<?php echo URL_MODEL;?>')">
								</div>
							</form>
						</div>
					</div>
					<div class="fr" style="    width: 418px;">
						<form action="<?php echo  M_URL('Flow','flowexcel','',GP('keyword-'.$keyword.',keytype-'.$keytype.',p-'.$page->now_page.',type-'.$type.',byname-'.$byname)); ?>" method="post">
						...
						<input type="submit" id="ratiotime" class=" btn  btn-default" name="" value="导出本页" style="position: relative;top: -4px;"/></label>
					</form>  
					</div>
		...
		<div id="ksBoxContent" style="margin-top: 28px; ">
			<div style="padding: 30px 0px;">
					...
					<ul class="H5-gameOpt clearfix">
						...
						<li>
							<div class="shaixuan clearfix">
								<?php if($byname == 'desc'){?>
									<a class="desc" href="<?php echo M_URL('Flow','index','',GP("byname-asc")); ?>"><i class="desc-i"></i>使用日期</a>		
								<?php }else{ ?>
									<a class="desc" href="<?php echo M_URL('Flow','index','',GP("byname-desc")); ?>"><i class="asc-i"></i>使用日期</a>
								<?php }?>
							</div>
						</li>
						<li>
						...
						<li class="fr gameScreen" style="font-size: 16px;margin-right: 20px;">
							...
							<ul class="H5-gameScreen">
								...
								<li>
									<span>使用类型：</span>
									<div>
										<a href="<?php echo M_URL('Flow','index','',GP('p-'.$page->now_page.',type-1'));?>" class='<?php if($type==1) echo " active" ;?>'>点播</a>
										<a href="<?php echo M_URL('Flow','index','',GP('p-'.$page->now_page.',type-4'));?>" class='<?php if($type==4) echo " active" ;?>'>回收站</a>
									</div>
								</li>
							</ul>
				...
				<div class="H5-gameListConts school-online">
					<form target="hidframe" action="<?php echo M_URL('Flow','delsome','',GP(" p-$page->now_page")); ?>" method="post" id="myform" >
								...
								<table width="100%" cellpadding="0" cellspacing="0" border="0" class="ks-table ">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<div class="operate">
													<a href="javascript:void(0);" onclick="Confirm('是否删除该条记录？该操作不可逆!','<?php echo M_URL('Flow','delRec',$v['id'],GP('p-'.$page->now_page)); ?>')">
						...
						<div class="footer-page">
							...
							<form action="<?php echo M_URL('Flow','flowTime','',GP(" "));  ?>" method="post">
								<div class="fl mt15">
