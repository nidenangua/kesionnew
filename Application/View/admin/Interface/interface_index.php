...
<div id="manage_top" class="menu_top_fixed  p15 height73" >
    <div class="ibox-title clearfix">
       <h3 class="fl ">&nbsp;&nbsp;<span class="mr20 act">接口管理</span>
        	<!-- <a href="<?php echo M_URL('Interface','index','',GP('')); ?>" class="mr20 act" style="color: blue"></a>  -->
        	<a href="<?php echo M_URL('Interface','classifyIndex','',GP('')); ?>" class="mr20 " >分类管理</a>
             <a class="btn btn-default btn-rounded " onclick="addTypeChange('<?php echo M_URL('home/Interface','showAddI','',GP('p-'.$now_page)) ?>','530px','400px',{title:'添加接口',type:'top'});" >添加接口</a>
        </h3>
        <div class="fr">
            ...
            <input style="position: relative;" type="submit" class="sc-button" onclick="searchByClass('<?php echo GP(''); ?>','<?php echo M_URL('Interface','index'); ?>','<?php echo URL_MODEL;?>')" name="searchBtn" value="搜索">
			</form>
         ...
         <table class="ks-table" style="background: #fff;">
                    ...
                    <tbody>
                    	...
                    	<tr>
                    		...
                    		<td><?php if($v['postway']==1){echo '普通post';}elseif($v['postway']==2){echo 'post对象';}elseif($v['postway']==3){echo 'GET';} ?></td>
                    		<td>
                    			 <span onclick="Confirm('是否删除？该操作不可逆!','<?php echo M_URL('Interface','deleteInterface',$v['id'],GP('')); ?>')"><i class="iconfont icon-lajitong"></i></span>
                    		</td>
                    		<td class="ks-head-el">
                                ...
                                <div class="ks-head-content ks-head-content-pc">
                                    <ul class="opeart">
                                        <li>
                                            <a onclick="addTypeChange('<?php echo M_URL('home/Interface','showAddI',$v['id'],GP('p-'.$now_page)) ?>','530px','400px',{title:'修改接口',type:'top'});">编辑</a>
                                        </li>
                                        <li>
