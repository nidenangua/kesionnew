...
<form target="hidframe"  method="post" id="myform" action="<?php echo M_URL('home/Domain','dopadSetting',$wxid,GP(''));?>" class="form-horizontal" enctype="multipart/form-data">
					...
					<ul>
						<li>
							...
							<div class="Created-Content clearfix">
								<textarea class="long-text" name="intro" style="min-height: 120px;"><?php echo $values['intro'];?></textarea>
							</div>
						</li>
	...
	/*
		...
		//图片改变情况
	     function tempRemove (target){
	     	console.log(1)
	     	tempSrc.splice(i,1); //splice方法会改变数组长度，当减掉一个元素后，后面的元素都会前移，因此需要相应减少i的值  
	     	console.log(tempSrc);
