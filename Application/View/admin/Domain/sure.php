...
<body class="gray-bg">
<div id="ksBoxContent">
<form target="hidframe"  method="post" target="hidframe"  action="<?php echo M_URL('home/Domain','doconfirmdel',$id,GP('p-'.$now_page)) ?>" class="form-horizontal" enctype="multipart/form-data">
重置后密码为：654321
<input name="password" type="password" value="" placeholder="输入操作码" />
