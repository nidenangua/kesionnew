...
<form target="hidframe" id="myform"  method="post" class="form-horizontal" action="<?php if(!empty($values)){echo M_URL('Label','Labeldoclone','',GP(''));}?>">
                <div class="tabs-container pt0" style="box-shadow: inherit;">
                    <div class="tab-content">
                    模板克隆到：
                    ...
                    <div class="footer-page ">
                        ...
                        <div class="col-sm-10 mt10">
                            ...
                            <a class="btn btn-default  btn-s-md" href="javascript:history.go(-1);" style="background: #ccc; color: #3A3D40 !important;" >取消</a>
                        </div>
                    </div>
                </div>
</form>
