...
<form target="hidframe" id="myform" class="form-horizontal" action="<?php if(empty($value)){echo M_URL('Label','LabeldoAdd','',GP(''));}else{echo M_URL('Label','LabeldoEdit',$labelid,GP('p-'.$now_page));} ?>" method="post" enctype="multipart/form-data">
        ...
        <!--<div class="line line-dashed b-b line-lg pull-in"></div>
        <div class="form-group">
            <label class="col-sm-2 control-label">输出方式</label>
            <div class="col-sm-4">
                <div class="radio radio-info radio-inline">
                    <input name="messageState" id="file1" required type="radio" checked="checked" value="1"><label for="file1"> 不采用Ajax </label>
                </div>
                <div class="radio radio-info  radio-inline">
                    <input name="messageState" id="file2" required type="radio" value="0"><label for="file2"> 采用Ajax输出 </label>
                </div>
            </div>
        </div>-->
        <div class="line line-dashed b-b line-lg pull-in"></div>
