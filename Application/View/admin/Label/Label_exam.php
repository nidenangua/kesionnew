...
<form target="hidframe" id="myform" class="form-horizontal" action="<?php if(empty($value)){echo M_URL('Label','LabeldoAdd','',GP('labeltype-'.$labeltype));}else{echo M_URL('Label','LabeldoEdit',$labelid,GP('p-'.$now_page));} ?>" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="hidden" value="10" id="appid">
            </div>
        </div>
        <div class="line line-dashed b-b line-lg pull-in"></div>
        <div class="form-group">
...
<option <?php if(!empty($value)){if($Label->GetParam($value['labelcontent'],'Order')=='newid()'){?>selected="selected"<?php }}?> value="newid()">随机显示</option>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8 taps-li">
              <ul id="field"><li onclick="InsertLabel('paperid','-1')">考卷ID</li><li onclick="InsertLabel('userid','-1')">用户ID</li><li onclick="InsertLabel('categoryid','14')">分类</li><li onclick="InsertLabel('Title','1')">标题</li><li onclick="InsertLabel('paperType','1')">考卷类型</li><li onclick="InsertLabel('exam_time','1')">考试时间</li><li onclick="InsertLabel('ExamScore','1')">考卷总分</li><li onclick="InsertLabel('AnswerNum','1')">答卷次数限制</li><li onclick="InsertLabel('exam_type','1')">题目添加类型</li><li onclick="InsertLabel('ExamTimeLimit','1')">时间限制</li><li onclick="InsertLabel('ExamBeginTime','1')">考试的开始时间</li><li onclick="InsertLabel('ExamEndTime','1')">考试的结束时间</li><li onclick="InsertLabel('inputer','1')">录入者</li><li onclick="InsertLabel('Intro','1')">试卷介绍</li><li onclick="InsertLabel('paper_level','1')">试卷难度</li><li onclick="InsertLabel('ExamNum','6')">考卷人数</li><li onclick="InsertLabel('Hits','1')">考卷人气</li></ul>
            </div>
        </div>
        <div class="line line-dashed b-b line-lg pull-in"></div>
        <div class="form-group">
