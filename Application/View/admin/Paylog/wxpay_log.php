...
<div id="manage_top" class="menu_top_fixed  p15 height73" >
    <div class="ibox-title">
        <h3 class="fl">&nbsp;&nbsp;网校流水
        	 <a href="<?php echo M_URL('Paylog','wxpaylog'); ?>" class="mr20 act" >消费明细</a> 
		    <a href="<?php echo M_URL('order/Index','index','',GP('appid-4',true)); ?>" class="mr20">订单管理</a>  
            &nbsp;&nbsp;&nbsp;&nbsp;总充值&nbsp;&nbsp;<font class="defColor" size="4px">￥<?php if($outmoney){echo $outmoney;}else{echo 0;} ?></font>
        ...
        <div class="fr">
			...
			<form target="hidframe" class="fr">		
				...
				<input type="text" class="sc-text" name="searchText" id="keyword" value="<?php if(isset($keyword)) echo $keyword; ?>">
           		<input type="button" class="sc-button fl" onclick="searchByClass('<?php echo GP(''); ?>','<?php echo M_URL('Paylog','wxpaylog'); ?>','<?php echo URL_MODEL;?>');" name="searchBtn" value="搜索">
			</form>
	...
	<div class="H5-gameListScreen">
        <ul class=" nav nav-tabs">
            ...
            <!--<li>转换率<i class="iconfont icon-sort-double-down"></i></li>-->
                <li class="fl hLh40 pl10 pr10 mr20 fsize18 <?php if($status==3) echo " curr" ;?>"><a href="<?php echo M_URL('home/Paylog','wxpaylog','',GP('status-3')); ?>" >全部</a></li>
                <li class="fl hLh40 pl10 pr10 mr20 fsize18 <?php if($status==1) echo " curr" ;?>"><a href="<?php echo M_URL('home/Paylog','wxpaylog','',GP('status-1')); ?>" >支出明细</a></li>
                <li class="fl hLh40 pl10 pr10 mr20 fsize18 <?php if($status==0) echo " curr" ;?>"><a href="<?php echo M_URL('home/Paylog','wxpaylog','',GP('status-0')); ?>">充值明细</a></li>           
        </ul>
			...
			<tr style="background: #EEEEEE;">
				...
				<th class="shaixuan">
                   <?php if($byname == 'a.adddate asc'){?>
                        <a class="desc" href="<?php echo M_URL('home/Paylog','wxpaylog','',GP("byname-a.adddate desc")); ?>" style="float: none;"><i class="desc-i" style="top: -1px;"></i>消费时间</a>     
                    <?php }else{ ?>
                        <a class="desc" href="<?php echo M_URL('home/Paylog','wxpaylog','',GP("byname-a.adddate asc")); ?>" style="float: none;"><i class="asc-i" style="top: -1px;"></i>消费时间</a>
                    <?php }?>            
                </th>
				<th>IP</th>
				<th>收入</th>
...
<div class="footer-page " style="height:60px;">
    <div class="col-sm-7 mt7 labs">
     <form action="<?php echo  M_URL('home/Paylog','wxpaylogexcel','',GP('')); ?>" method="post">
	...
	<div class="col-sm-5 mt7"> <?php echo $page->show(3); ?></div>
 <script>
	var start = {
	  elem: '#start',
