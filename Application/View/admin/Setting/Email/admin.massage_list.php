...
<div class="wrapper wrapper-content mt55 animated fadeIn">
  <div class="row">
        ...
        <div class="ibox-title">
            <h3 class="fl mr15">短信模板管理
           	 <ul id="tablist" class="ml15">
				            ...
				            <li class="active"><a href="<?php echo M_URL('Setting','emailmassage'); ?>">站内信模块</a></li>
                            <li class=""><a href="<?php echo M_URL('Setting','cardTemplate'); ?>">微名片服务通知</a></li>

             </ul>
            </h3>
            <a class="btn btn-info btn-rounded btn-default btn-s-md " href="<?php echo M_URL('Setting','emailaddmassage'); ?>">新增模块</a>
    ...
    <div class="row">
      <form target="hidframe"  action="<?php echo M_URL('Setting','emailmassagebeach') ?>" method="post">
                  ...
                  <table class="table table-bordered">
                    ...
                    $html="<tr>
                      ...
                      <td style='width:160px;'>
                        <div class='col-sm-9'>
                          <input class='form-control' name='massagenum[]' value='".$v["massagenum"]."' type='number' >             
                          <input style='display:none' value='".$v["id"]."' name='id[]'>
                        </div>
                        <label class='col-sm-3 control-label' style='padding-top: 7px'>条</label>
                
                </td><td>";

                $html.=" <a href='".M_URL('Setting','emaileditormassage',$v["id"])."' ><i class='edit2017'></i></a>";
                if($v["issys"]==0){
                $html.="<a href='javascript:void(0);'  onclick=\"Confirm('是否删除此模块？该操作不可逆！','".M_URL('Setting','emaildelmassage',$v["id"])."')\"><i class='delete2017'></i></a>";
                }
                $html.="</td> </tr>";
                echo $html;
                }
