...
<div class="tab-content">
    <div class="tap-pane pd0" style="display: block">
        ...
        <form action="<?php echo M_URL('Setting','batch','',GP('')); ?>" method="post" target="hidframe" id="myform">
            <table class="table table-striped table-bordered table-hover" id="editable">
                ...
                <tr>
                    <td style="width: 70px"><?php echo $v['id'] ?><input name=id[] type="hidden" value="<?php echo $v['id'] ?>"></td>
                    <td >
                    ...
                    <td style="width: 90px"><a onclick="addTypeChange('<?php echo M_URL('Setting','liveView',$v['id'],GP('type-'.$type));  ?>','800px','600px')"><i class="show2017"></i></a></td>
                    <td style="width: 90px"><a href="<?php echo M_URL('Setting','editInterface',$v['id'],GP('type-'.$type)); ?>"><i class="edit2017"></i></a></td>
                    <td style="width: 90px">
                     <?php if ($v['id']>10){ ?>
                      <a onclick="Confirm('是否删除此应用','<?php echo M_URL('Setting','delInterface',$v['id'],GP('')); ?>');"><i class="delete2017"></i></a>
                     <?php
                           }else{
                               echo ('-');
                           }
            ...
            <div class="footer-page">
                   ...
                   <div class="col-sm-7 mt3"> 
                   <button class="btn btn-primary btn-s-md fl mt7" type="button" onClick="do_reg()">确定保存</button>
