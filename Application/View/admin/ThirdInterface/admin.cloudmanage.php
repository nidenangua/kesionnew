        ...
        <form action="<?php echo M_URL('ThirdInterface','batch','',GP('')); ?>" method="post" target="hidframe" id="myform">
            <table class="table table-striped table-bordered table-hover" id="editable">
                ...
                <tr>
                    ...
                    <td style="width: 90px"><a onclick="addTypeChange('<?php echo M_URL('ThirdInterface','liveView',$v['id'],GP('type-'.$type));  ?>','800px','600px')"><i class="show2017"></i></a></td>
                    <td style="width: 90px"><a href="<?php echo M_URL('ThirdInterface','editInterface',$v['id'],GP('type-'.$type)); ?>"><i class="edit2017"></i></a></td>
                    <td style="width: 90px">
                     <?php if ($v['id']>10){ ?>
                      <a onclick="Confirm('是否删除此应用','<?php echo M_URL('ThirdInterface','delInterface',$v['id'],GP('')); ?>');"><i class="delete2017"></i></a>
                     <?php
                           }else{
                               echo ('-');
                           }
