    ...
    <div class="tab-content">
        <div class="tap-pane" style="display: block">
            <div class="panel-body">
                <form id="myform" target="hidframe"  class="form-horizontal" method="post" action="<?php if(isset($live)){echo M_URL('ThirdInterface','doeditlive',$id,GP(''));}else{echo M_URL('ThirdInterface','doaddlive','',GP(''));} ?>">
                 	<div class="form-group-box">
                        ...
                        <div class="line line-dashed b-b line-lg pull-in"></div>
                 		...
                 		<?php if(isset($live)){foreach($key as $k=>$v){ ?>
                        <div class="form-group">
