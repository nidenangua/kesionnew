...
<form target="hidframe" class="form-horizontal" action="<?php if(empty($value)){echo M_URL('Temp','bgmdoAdd',$id);}else{echo M_URL('Temp','bgmdoEdit',$value['id'],GP('p-'.$now_page.',tempid-'.$value['tempid']));} ?>" method="post" enctype="multipart/form-data">
							...
							<div class="">
				          		<div class="js_uploadBox">
					                <div class="btn-upload clearfix">
					                    <a href="javascript:addTypeChange('<?php echo M_URL('Index','musiclist','',GP('type-top,name-fileurl',true));?>','930px','610px',{title:'选择音乐',type:'top'});" class="selectImageBtn">
