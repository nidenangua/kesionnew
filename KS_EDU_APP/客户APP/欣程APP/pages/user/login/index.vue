			...
			<view class="ulogin-position">
				...
				<view class="ulogin-box">
					<view class="ulogin-box__item">
						<image class="ulogin-box__icon" :src="baseUrl+'/static/images/login/sign_icon_account_s.png'"></image>
						<input class="ulogin-box__input" v-model="username" placeholder="用户名" />
					</view>
					<view class="ulogin-box__item">
						<image class="ulogin-box__icon" :src="baseUrl+'/static/images/login/sign_icon_password_s.png'"></image>
