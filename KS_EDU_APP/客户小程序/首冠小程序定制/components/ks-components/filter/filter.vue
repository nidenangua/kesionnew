<template>
	<div class="ks-filter">
		...
		<view v-if="action==1" class="filters">
			<view class="filter clearfix withe-bg">
				<view class="filter-col ks-col-12">
					<view class="uni-input" @click="bindFilter('sort')" :class="filterSort?'on':''">{{sortList[sortIndex].name}}</view><image :src="baseUrl+'/static/images/choose-cade/choose-Cades.png?2.0'" class="arrow" v-if="filterSort"></image><image :src="baseUrl+'/static/images/choose-cade/choose-Cadex.png?2.0'" class="arrow" v-else></image>
				</view>
				<view class="filter-col ks-col-12">
					<view class="uni-input" @click="bindFilter('sorts')" :class="filterSorts?'on':''">{{sortLists[sortIndexs].name}}</view><image :src="baseUrl+'/static/images/choose-cade/choose-Cades.png?2.0'" class="arrow" v-if="filterSorts"></image><image :src="baseUrl+'/static/images/choose-cade/choose-Cadex.png?2.0'" class="arrow" v-else></image>
				</view>
			</view>
			<view class="filter-list withe-bg filter__sort" v-if="filterSort">
				<view v-for="(item,i) in sortList" class="item" :key="item.type" :class="item.type==orderid?'curr':''" @click="selectItem(item.type,i)">
					{{item.name}}<i class="selected" :style="'background: url('+baseUrl+'/static/images/choose-cade/lesson_icon_select@2x.png?2.0) no-repeat center;background-size:17px;'"></i>
				</view>
			</view>
		...
		<view v-else>
			<view class="filter clearfix withe-bg">
				<view class="filter-col ks-col-12">
					<view class="uni-input" @click="bindFilter('class')" :class="filterClass?'on':''">{{classList[classIndex].className}}</view><image :src="baseUrl+'/static/images/choose-cade/choose-Cades.png?2.0'" class="arrow" v-if="filterClass"></image><image :src="baseUrl+'/static/images/choose-cade/choose-Cadex.png?2.0'" class="arrow" v-else></image>
				</view>
				<view class="filter-col ks-col-12">
					<view class="uni-input" @click="bindFilter('sort')" :class="filterSort?'on':''">{{sortList[sortIndex].name}}</view><image :src="baseUrl+'/static/images/choose-cade/choose-Cadex.png?2.0'" class="arrow" v-if="filterSort"></image><image :src="baseUrl+'/static/images/choose-cade/choose-Cades.png?2.0'" class="arrow" v-else></image>
				</view>
			</view>
