<template>
	<view class="content" v-if="loaded">
		...
		<view class="fab" v-if="currentNav=='ask'">
			<view class="fab-button" :style="'background: url('+baseUrl+'/static/images/common/asksubmit.png) center #ff663d;background-size: 100% 100%;'" @click="askShow"></view>
