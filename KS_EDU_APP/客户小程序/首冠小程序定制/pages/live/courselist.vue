<template>
	<view style="background: #fff;">
		...
		<view :class="visible?'popup-box':'hide-box'"    @touchmove.stop >
			...
			updateClass(){
				return new Promise(resolve=>{
					...
					GetCourseClass({
						...
						this.ejList = [{className:'全部',classId:this.yjList[1].classId}],
						this.activeIdList = [this.yjList[1].classId]
						if(this.yjList[1].childs){
							this.ejList = this.ejList.concat(this.yjList[1].childs)
							this.sjList = [{className:'全部',classId:this.ejList[1].classId}],
							this.activeIdList = [this.yjList[1].classId,this.ejList[1].classId]
							if(this.ejList[1].childs){
								this.sjList = this.sjList.concat(this.ejList[1].childs)
								this.activeIdList = [this.yjList[1].classId,this.ejList[1].classId,this.sjList[1].classId]
							}
						}
