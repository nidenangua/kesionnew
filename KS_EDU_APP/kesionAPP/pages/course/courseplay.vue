	...
	<view class="course-play">
		...
		<view v-show="currentTab == 0">
			<view class="course-head" style="display: flex;">
				...
				<view style="font-size: 12px; color:#999; text-align: center;" v-if="state.isCache" @click="openDownload()">
					<image style="width: 20px;height: 20px;display: block;margin:0 auto;" :src="baseUrl+'/static/icon/download.png'"></image>
					<text>下载</text>
				</view>
			</view> 
