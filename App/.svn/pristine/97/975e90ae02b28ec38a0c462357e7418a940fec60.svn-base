						...
						<div class="fr" >
							<div class="fr">
								<ul class="ks-head-choice">
										...
										<div class="ks-head-content ks-head-content-pr" style="width: 360px;">
												...
												<ul class="screen">															
													<li>
														<span>试卷状态：</span>
															<div>
															<a href="<?php echo M_URL($this->AppName.'/Index','index','',GP('status-2')); ?>" <?php if($status==2){echo 'class="choice-active"'; } ?> >不限</a>
															<a href="<?php echo M_URL($this->AppName.'/Index','index','',GP('status-1')); ?>" <?php if($status==1){echo 'class="choice-active"'; } ?> >已审核</a>
									...
									<li>	
										<div class="ks-head-el">									
									  <a class="ks-heade-button ks-head-primary" href="<?php echo M_URL($this->AppName.'/Index','paperAdd','',GP('')); ?>" class="alignCenter"><i class="iconfont icon-jiahao"></i> 添加试卷</a>
										</div>
									</li>
									<li>
									<?php if($setting[5] ==1){ ?>	
...
<tr>
	...
	<td class="ks-head-el">
		...
		<div class="ks-head-content ks-head-content-pc w100">
			<ul class="opeart">
				<li>
					<a href="<?php echo M_URL($this->AppName.'/Index','preview',$v['paperid'],GP('p-'.$page->now_page)); ?>">预览</a>
				</li>
				<li >
					<a href="<?php echo M_URL($this->AppName.'/Index','editPaper',$v['paperid'],GP('p-'.$page->now_page)); ?>">编辑</a>
				</li>
				<li >
					<a href="javascript:void(0);" onclick="Confirm('是否删除此试卷？该操作不可逆!','<?php echo M_URL($this->AppName.'/Index','delPaper',$v['paperid'],GP('')); ?>')">删除</a>
				</li>
				<li >
					<a href="<?php echo M_URL($this->AppName.'/Index','userPaper',$v['paperid'],GP('p-'.$page->now_page)); ?>">批卷</a>
				</li>
			</ul>
		</div>
	</td>
