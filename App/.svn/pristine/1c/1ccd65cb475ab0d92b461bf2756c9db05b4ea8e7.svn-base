...
var myTask = new Object({
	...
	postar: function postar(id, type) {
		...
		if (type == 'add') {
			var ajax = {
				url: '/Json/index.php?act=Exam.addcollectionTk&tkid=' + id +'&paperid='+myTask.paperid+'&modeltype='+modeltype,
				data: ''
			};
		} else if (type == 'del') {
			var ajax = {
