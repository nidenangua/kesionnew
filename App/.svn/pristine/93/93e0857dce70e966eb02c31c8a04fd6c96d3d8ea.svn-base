...
<div class="Header-tool clearfix"> 
		   ...
		   <div class="fr" style="    width: 418px;">
						<form action="<?php echo  M_URL($this->AppName.'/Index','buyexcel','',GP('p-'.$page->now_page.',wxid-'.$wxid.',adddate-'.$adddate.',numb-'.$numb)); ?>" method="post">
			...
			<div class="tap-ban">
					<table class="ks-table pay-border">
		   						...
		   						<tr>
		   							...
		   							<td><?php echo floor($v['numb']).'个';?></td>
		   							<td><?php echo $v['market_price'].'个/元';?></td>	
