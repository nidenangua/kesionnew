	...
	<div id="ksBoxHead" >
		...
		<div class="Header-tool clearfix">
			...
			<ul class="Tool-nav">
				...
				<li class="curr">
					<a   href="<?php echo M_URL($this->AppName.'/Index','showSupervene','',GP('')); ?>" target="main">并发管理</a>
				</li>	
				<!--<li>
			...
			<div class="fr" style="    width: 418px;">
						<form action="<?php echo  M_URL($this->AppName.'/Index','spaceExcel','',GP('keyword-'.$keyword.',keytype-'.$keytype.',p-'.$page->now_page.',stype-'.$type.',status-'.$status)); ?>" method="post">
						...
						<li class="fr gameScreen" style="margin-right: 20px;">
							...
							<ul class="H5-gameScreen">
								...
								<li>
									<span>支付状态：</span>
									<div>
										<a href="<?php echo M_URL($this->AppName.'/Index','showSpace','',GP('p-'.$page->now_page.',status-3'));?>" class='<?php if($status==3) echo " active" ;?>'>不限</a>
										<a href="<?php echo M_URL($this->AppName.'/Index','showSpace','',GP('p-'.$page->now_page.',status-1'));?>" class='<?php if($status==1) echo " active" ;?>'>已支付</a>
										<a href="<?php echo M_URL($this->AppName.'/Index','showSpace','',GP('p-'.$page->now_page.',status-2'));?>" class='<?php if($status==2) echo " active" ;?>'>未支付</a>
									</div>
								</li>
								<li>
									<span>时限类型：</span>
