...
class CommonController extends Controller
{
    public  function _initialize()
    {
		...
		$this->appid       = ChkClng(KS_S('appid'));
		check_power($this->userinfo,'store_category','index2,delCategory,byOneDown');//检查管理员权限
		...
		$this->AppModel    = new CategoryModel('app_'.$this->app['tableename']);
    }
}