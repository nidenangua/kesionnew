		 	 ...
		 	 <div class="stuConBox bg-white bRadius10">
                 ...
                 <div id="lisHeight">
							 ...
							 <div class="stuitem">
							 	...
							 	<?php if($vt['tktype'] == 1){   //单选题
							 		  $a =range('A','Z') ;
							 		  $option =explode('$$$',$vt['options']);
								...
								<div class="exercise-answer">
									<ul>
										<li>参考答案：<?php echo $vt['anser']; ?></li>
										<li>答案解析:<?php echo $vt['analysis']; ?></li>
									</ul>
								</div>
								
							  </div> 					
							 <?php 	}  ?>
							 <?php if($vt['tktype'] == 2){//填空题
							 	 $find = '{#answer}';
							      $repl = '_______';
								  $options = str_replace($find,$repl,$vt['options']);
								 ?>	
				            ...
				            ?>	
							  ...
							  <?php  if($vt['tktype']==4){//问答题
					       
									   $stem4 = $vt['options'];
						               
						               $anser = explode('$$$', $vt['anser']);
