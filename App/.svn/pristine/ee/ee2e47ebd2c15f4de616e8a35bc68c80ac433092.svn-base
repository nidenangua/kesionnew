						...
						<li class="fr gameScreen" style="margin-right: 20px;">
							...
							<ul class="H5-gameScreen">
								...
								<li>
									<span>账号状态：</span>
									<div>
										<a href="<?php echo M_URL($this->AppName.'/Index','index','',GP('p-'.$page->now_page.',active-3'));?>" class='<?php if($status==3) echo " active" ;?>'>不限</a>
										<a href="<?php echo M_URL($this->AppName.'/Index','index','',GP('p-'.$page->now_page.',active-1'));?>" class='<?php if($status==1) echo " active" ;?>'>通过</a>
										<a href="<?php echo M_URL($this->AppName.'/Index','index','',GP('p-'.$page->now_page.',active-2'));?>" class='<?php if($status==2) echo " active" ;?>'>未通过</a>
									</div>
								</li>
							</ul>
