...
<body class="gray-bg">
<div id="ksBoxContent">
<form target="hidframe"  method="post" target="hidframe"  action="<?php echo M_URL($this->AppName.'/Index','doconfirmdel',$id,GP('p-'.$now_page)) ?>" class="form-horizontal" enctype="multipart/form-data">
输入操作密码
