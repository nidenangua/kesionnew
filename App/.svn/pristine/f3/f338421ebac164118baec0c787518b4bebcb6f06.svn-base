...
<div id="manage_top " class="menu_top_fixed ">
            ...
            <div class="ibox float-e-margins">
              <div class="ibox-content">
			   ...
			   if($page->now_page!=1||$k!=0){
									$html .= "<form target='hidframe'  method='post' action='".M_URL($this->AppName.'/Index','byOneUp',$v['categoryid'],GP('p-'.$page->now_page))."' class='form-horizontal'>
											<div class='col-sm-2'>
 ...
 if($page->now_page!=$page->total_pages||$k!=$count-1){							 
									$html .= "<form target='hidframe'  method='post' action='".M_URL($this->AppName.'/Index','byOneDown',$v['categoryid'],GP('p-'.$page->now_page))."' class='form-horizontal'>
											<div class='col-sm-2'>
												<input type='hidden' name='rootid' value='$v[rootid]'/>
												<select class='form-control' name='MoveNum'>
													<option>向下移动</option>";
