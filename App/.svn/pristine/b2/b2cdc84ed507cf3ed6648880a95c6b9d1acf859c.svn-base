...
<body class="ks-wrap">
	...
	<div id="ksBoxHead">
		  <a href="javascript:void(0)" class="ks-bt bt-def mr10" onclick="excelUser();" id="addStudent">
	...
	<form target="hidframe"  action="<?php  echo M_URL($this->AppName.'/Index','doaddStudent',$classroomid,GP('p-'.$page->now_page)) ?>" method="post" id="myform">
	<div class="clearfix" style="height:400px;">
		...
		<ul class="Aconts-ul">
			<li class="card-li add" onclick="skip('<?php echo M_URL($this->AppName.'/Index','addStudent',$classroom,GP("usertype-0")) ?>');">							
