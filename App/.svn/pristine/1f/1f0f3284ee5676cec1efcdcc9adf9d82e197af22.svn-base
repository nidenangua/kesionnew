	...
	<div class="H5-gameListScreen">
        <ul class=" nav nav-tabs">
            ...
            <!--<li>转换率<i class="iconfont icon-sort-double-down"></i></li>-->
                <li class="fl hLh40 pl10 pr10 mr20 fsize18 <?php if($status==3) echo " curr" ;?>"><a href="<?php echo M_URL('h5market/Index','collage','',GP('status-3')); ?>" >全部</a></li>
                <li class="fl hLh40 pl10 pr10 mr20 fsize18 <?php if($status==1) echo " curr" ;?>"><a href="<?php echo M_URL('h5market/Index','collage','',GP('status-1')); ?>" >进行中</a></li>
                <li class="fl hLh40 pl10 pr10 mr20 fsize18 <?php if($status==0) echo " curr" ;?>"><a href="<?php echo M_URL('h5market/Index','collage','',GP('status-0')); ?>">未开启</a></li>           
                <li class="fl hLh40 pl10 pr10 mr20 fsize18 <?php if($status==2) echo " curr" ;?>"><a href="<?php echo M_URL('h5market/Index','collage','',GP('status-2')); ?>">已结束</a></li>        
                <li class="fl hLh40 pl10 pr10 mr20 fsize18"><a href="<?php echo M_URL('h5market/Index','failurelist','',GP('status-2')); ?>">失败</a></li>    
        </ul>
		...
		<tbody>
			<?php foreach ($values as $k => $v) { ?>
             <tr> 
                ...
                <td> <a style="color: blue" href="<?php echo M_URL('h5market/Index','collagesituation',$v['id'],GP('appid-26,status-3',true)); ?>"><?php echo $v['groupnum']; ?></a></td>
                <td> <a style="color: blue" href="<?php echo M_URL('h5market/Index','collagesituation',$v['id'],GP('appid-26,status-1',true)); ?>"><?php echo $v['groupnum1']; ?></a></td>
                <td> <a style="color: blue" href="<?php echo M_URL('h5market/Index','collagesituation',$v['id'],GP('appid-26,status-0',true)); ?>"><?php echo $v['groupnum2']; ?></a></td>
                ...
                <td>
        		  <span onclick="Confirm('是否删除？该操作不可逆!','<?php echo M_URL('h5market/Index','deleteCollage',$v['id'],GP('')); ?>')"><i class="iconfont icon-lajitong"></i></span>
        		</td>
               <!--  <td class="ks-head-el">
