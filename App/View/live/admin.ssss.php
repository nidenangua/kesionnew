...
<div class="Header-tool clearfix"> 
			...
			<div class="fl ks-view-tab mt10">
						<ul>  
							<li   <?php if(ACTION =='serviceRecord' ){echo 'class="curr"';} ?> ><a href="<?php echo M_URL('Shop','serviceRecord',5); ?>">购买记录</a></li>
							<li   <?php if(ACTION =='consumptionRecord' ){echo 'class="curr"';} ?>><a href="<?php echo M_URL('Shop','consumptionRecord',5); ?>">消费记录</a></li>
						</ul>
			</div>
		   						...
		   						<tr>
		   							...
		   							<td>
		   								<?php 
		   									switch($v['appid']){
		   										case 1:
		   										echo ($v['numb']*1000).'条';break;
		   										case 2:
		   										echo ($v['numb']*1000).'封';break;
		   										case 3:
		   										echo floor($v['numb']).'G';break;
		   										case 4:
		   										echo floor($v['numb']).'G';break;
		   										case 6:
		   										echo floor($v['numb']).'人';break;
		   										case 5:
		   										echo floor($v['numb']).'个';break;
		   							...
		   							<td>
		   								...
		   								<?php 
		   									switch($v['appid']){
		   										case 1:
		   										echo $v['market_price'].'/千条';break;
		   										case 2:
		   										echo $v['market_price'].'/千封';break;
		   										case 3:
		   										echo  $v['market_price'].'/G/天'; break;
		   										case 4:
		   										echo $v['market_price'].'/G';break;
		   										case 6:
		   										echo $v['market_price'].'/人/月';break;
		   										case 5:
		   										echo $v['market_price'].'个/元';break;
		   							...
		   							<td>
		   								<?php 
		   									switch($v['appid']){
		   										...
		   										echo '--';break;
		   										case 3:
		   										echo  date('Y-m',$v['starttime']).'~'. date('Y-m',$v['endtime']); break;
		   										case 4:
		   										echo '--';break;
   					...
   					<div class="tap-ban">
	   					...
	   					<table class="ks-table pay-border">
	   						...
	   						<tr>
	   							...
	   							<th><a href="<?php echo M_URL('Shop','wheatis',$v['id']); ?>">查看</a></th>
	   						</tr>
	   						<?php } ?>
	   					</table>	
   					</div>
