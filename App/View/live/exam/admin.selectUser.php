      ...
      <div class="search-main fr">
       ...
       <ul class="nav nav-tabs">
        ...
        <div class="tab-content">
		 ...
		 var addtype = <?php echo $addtype ?>	 
		 
         var userid = $('input:radio:checked').val();
		
		 if(addtype==1){
		
	     var url = '<?php echo M_URL($this->AppName.'/Index','paperAdd','',GP('')); ?>,userid-'+userid;
		 
		 }else if(addtype ==2){
			 
		  var url = '<?php echo M_URL($this->AppName.'/Index','addTk','',GP('')); ?>,userid-'+userid;
		 	 
		 }else if(addtype == 3){
			 
			 var url = '<?php echo M_URL($this->AppName.'/Index','scoreRank','',GP('')); ?>,userid-'+userid;
			 
		 }else if(addtype == 4){
			 
			 var url = '<?php echo M_URL($this->AppName.'/Index','paperType','',GP('')); ?>,userid-'+userid;
