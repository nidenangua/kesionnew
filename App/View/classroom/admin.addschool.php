...
<body class="ks-wrap" style="padding: 0;">
	<div class="ks-wbox">
		<form target="hidframe"  method="post" action="<?php if(isset($school)){echo M_URL($this->AppName.'/Index','doeditSchool','',GP('id-'.$school['schoolid'])); }else{echo M_URL($this->AppName.'/Index','doaddschool','',GP(''));} ?>"  id="myform">
