...
<div class="Header-tool clearfix"> 
		...
		<div class="fr" style="    width: 418px;">
						<form action="<?php echo  M_URL($this->AppName.'/Index','Cflowexcel','',GP('p-'.$page->now_page.',wxid-'.$wxid.',flow-'.$flow.',playcount-'.$playcount)); ?>" method="post">
					...
					<ul class="H5-gameOpt clearfix">
						...
						<li>
							<div class="shaixuan clearfix">
								<?php if($adddate == 1){?>
									<a class="desc" href="<?php echo M_URL($this->AppName.'/Index','consumptionRecord','',GP("adddate-2")); ?>"><i class="desc-i"></i>使用时间</a>		
								<?php }else{ ?>
									<a class="desc" href="<?php echo M_URL($this->AppName.'/Index','consumptionRecord','',GP("adddate-1")); ?>"><i class="asc-i"></i>使用时间</a>
								<?php }?>
							</div>
						...
						<li >
							<div class="shaixuan clearfix">
								...
								<?php if($flow == 1){?>
									<a class="desc" href="<?php echo M_URL($this->AppName.'/Index','consumptionRecord','',GP("flow-2")); ?>"><i class="desc-i"></i>使用流量</a>		
								<?php }else{ ?>
									<a class="desc" href="<?php echo M_URL($this->AppName.'/Index','consumptionRecord','',GP("flow-1")); ?>"><i class="asc-i"></i>使用流量</a>
								<?php }?>
							</div>
						</li><li >
							<div class="shaixuan clearfix">
								...
								<?php if($playcount == 1){?>
									<a class="desc" href="<?php echo M_URL($this->AppName.'/Index','consumptionRecord','',GP("playcount-2")); ?>"><i class="desc-i"></i>播放次数</a>		
								<?php }else{ ?>
									<a class="desc" href="<?php echo M_URL($this->AppName.'/Index','consumptionRecord','',GP("playcount-1")); ?>"><i class="asc-i"></i>播放次数</a>
								<?php }?>
							</div>
						</li>
					</ul>
