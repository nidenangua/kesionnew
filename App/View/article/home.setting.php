	   ...
	   <form target="hidframe"  action="<?php echo M_URL($this->AppName.'/Index','doSetting','',GP('')) ?>" method="post" id="myform">
		   <div class="webConBox">
             <div class="configTab" style="display:block;">
                 <table>
                     <tr>
                         <td class="leftTd alignRight fsize16 c-92 w300">是否开启文章:</td>
                    ...
                    <tr>
                         <td class="leftTd alignRight fsize16 c-92 w300">文章是否审核:</td>
					     <td class="rightTd alignLife">
                    ...
                    <tr>
					     ...
					     <td class="rightTd alignLife">
					        <input type="radio" name="setting2" value="1"  <?php if(isset($setting[1])){if($setting[1] ==1) echo 'checked';}else{echo 'checked'; } ?> class="radioInput">
					        	
                            <span class="radioName fsize16 c-92">启用</span>
                            <input type="radio" name="setting2" value="0"  <?php if(isset($setting[1])){if($setting[1] ==0) echo 'checked ';} ?>     class="radioInput">
                            <span class="radioName fsize16 c-92">不启用</span>
					     </td>
                    </tr>
                     <tr>
