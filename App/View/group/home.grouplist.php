				...
				<div class="ks-search-box fl">
					...
					<form target="hidframe">
						...
						<select class="w150 inputText bRadius5 fl" id="keytype">
							<option value="1" <?php if($keytype==1){echo 'selected="selected"';} ?>>分组名称</option>
						</select>
					...
					<ul class="ks-head-choice">
						...
						<li>
							<div class="ks-head-el">
								<a class="ks-heade-button ks-head-primary" type="button"  href="<?php echo M_URL($this->AppName.'/Index','groupAdd','',GP("appid-$this->appid")); ?>"  onclick="return checkpower({'version':'<?php echo checkIsVipModule($this->wxid,3,false,true);?>'})"><i class="icon-jiahao iconfont "></i>添加分组</a>
					...
					<tr>
							...
							<tbody>
								...
								<tr>
									...
									<td><?php echo Field($v['count']); ?>&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo M_URL('users/Index','index',0,GP("appid-3,groupid-".$v['id'])); ?>" style="color: blue;">查看</a></td>
