		 ...
		 <!--widget-->
					<div class="ks-head-widget clearfix">
						...
						<i class="iconfont icon-setting"></i>
									...
									<li>
										<div class="ks-head-el">
									<button class="ks-heade-button ks-head-primary" type="button" onclick="addTypeChange('<?php echo M_URL($this->AppName.'/Index','PLexcel','',GP(''));  ?>','600px','450px',{title:'word导入（按题目类型）',type:'top'});"><i class="icon-jiahao iconfont "></i>试题导入</button>
										</div>
								</li>
				...
				<table class="ks-table">
				 ...
				 ?>
						<tr>
							...
							<td style="text-align: left;max-width: 300px;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;"><?php echo Field(trim($v['options']))?></td>
							<td ><p style="max-width: 600px;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;"><?php echo Field($v['anser']) ?></p></td>
