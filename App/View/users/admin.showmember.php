		...
		<form target="hidframe"  method="post" action="<?php if(isset($value)){echo M_URL($this->AppName.'/Index','changeMsg',$value['id'],GP('')); }else{echo M_URL($this->AppName.'/Index','doaddClassroom','',GP(''));} ?>"  id="myform">
  		<div id="ksBoxContent" style="padding-left: 15px;">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0" class="ks-table ks-borde">                     
                  ...
                  <tbody>
                        <tr>   
	                       	 <td>学生账号:<?php echo $info['username']?></td>
	                         <td>学生名称:<?php if($info['name']){echo $info['name'];}else{echo '无';} ?></td>
	                        
						</tr>
						
                     
                         <tr>
                        	<td>学生名称:<?php if($info['ename']){echo $info['ename'];}else{echo '无';} ?></td>
                        	<td>学生性别: <?php if($info['Sex']==0){echo '男';}else{echo '女';} ?></td>
                        ...
                        <tr>
                        	 ...
                        	 <td>
                        		学生QQ:<?php if($info['QQ']){echo $info['QQ'];}else{echo '无';}?>
                        	</td>
                        	
                        </tr>    
                          <tr>
                          	<td>
                        		上课教室:<?php if($info['classroom']){echo $info['classroom'];}else{echo '无';}?>
                        	</td>
                        	 <td colspan="2">学生简介:<?php if($info['sign']){echo $info['sign'];}else{echo '无';} ?></td>
